...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add'])) {
        ...
        $sql = "INSERT INTO penyakit (kode, nama, deskripsi) VALUES ('$kode', '$nama', '$deskripsi')";
        ...
        $nama = $_POST['nama'];
        $deskripsi = $_POST['deskripsi'];
        $sql = "UPDATE penyakit SET kode='$kode', nama='$nama', deskripsi='$deskripsi' WHERE id=$id";
        mysqli_query($conn, $sql);
...
<body>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th width="50" class="justify">Deskripsi</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td width="50" class="justify"><?php echo $row['deskripsi']; ?></td>
                                    <td width="10" class="text-center">
                                        <a href="#" class="btn btn-warning m-1" data-bs-toggle="modal" data-bs-target="#editModal" onclick="fillEditModal(<?php echo $row['id']; ?>, '<?php echo $row['kode']; ?>', '<?php echo $row['nama']; ?>', '<?php echo $row['deskripsi']; ?>')">Edit</a>
    ...
    <script>
        ...
        function fillEditModal(id, kode, nama, deskripsi) {
