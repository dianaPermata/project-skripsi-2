...
$aturan_query = mysqli_query($conn, "SELECT aturan.id, penyakit.nama as penyakit, gejala.nama as gejala
                                FROM aturan
...
// Handle pagination
$total_records = mysqli_num_rows($aturan_query);
                                ...
                                <form method="POST" action="aturan.php">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <select id="gejala_id" name="gejala_id" class="form-select">
                                            <?php mysqli_data_seek($gejala, 0); // Reset pointer to beginning ?>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($aturan)) :
                            ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                    ...
                    <ul class="pagination">
                        <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
                            <li class="page-item <?php echo ($page == $i) ? 'active' : ''; ?>">
                                <a class="page-link" href="aturan.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                            </li>
                        <?php endfor; ?>
                    </ul>
                </nav>
